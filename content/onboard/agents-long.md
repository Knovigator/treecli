...
- Video sound effects: `treecli action sfx "rain, tires on wet asphalt, distant thunder"` or `treecli generate sfx "rain, tires on wet asphalt, distant thunder" --out sfx.mp4`; aliases include `sfx`, `mmaudio`, and `foley`.
